...
config.JobType.scriptArgs = ['Nevents=10000', 'Tag=testmini', 'DIR=2022postEE', 'DEST=root://eosuser.cern.ch//eos/project/h/htozg-dy-privatemc/pelai/HZg/root_DYfilter/test_newfilter_mini/2022postEE', 'Submitter=pelai']
