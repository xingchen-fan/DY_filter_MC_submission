...
# (comment removed: see Run3/README.md)
# (comment removed: see Run3/README.md)
config.General.requestName = 'DY2022postEE_nt8test16'
...
config.JobType.scriptArgs = ['Nevents=10000', 'Tag=nt8test16', 'DIR=2022postEE', 'DEST=root://eosuser.cern.ch//eos/project/h/htozg-dy-privatemc/pelai/HZg/root_DYfilter/nt8test/2022postEE', 'SeedBase=800060000']
