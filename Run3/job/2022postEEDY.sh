...
#   GEN-SIM     CMSSW_12_4_11_patch3 (124X_mcRun3_2022_realistic_postEE_v1)
#   DIGI+HLT    CMSSW_12_4_11_patch3 (124X_mcRun3_2022_realistic_postEE_v1), HLT:2022v14
#   MINIAOD     CMSSW_13_0_13 (130X_mcRun3_2022_realistic_postEE_v6)
#   NANOAOD     CMSSW_13_0_13 (130X_mcRun3_2022_realistic_postEE_v6)
...
cmsDriver.py Configuration/GenProduction/python/$Fragment_filename \
    ...
    --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision \
...
cmsDriver.py --python_filename $TAG"__DIGIPREMIX__cfg_"$NJOB".py" --eventcontent PREMIXRAW \
    ...
    --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:2022v14 \
...
cmsDriver.py --python_filename $TAG"__MINIAOD__cfg_"$NJOB".py" --eventcontent MINIAODSIM \
    ...
    --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step PAT --geometry DB:Extended \
...
cmsDriver.py --python_filename $TAG"__NANOAOD__cfg_"$NJOB".py" --eventcontent NANOAODSIM \
    ...
    --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step NANO --scenario pp \
